...
#include "Sources/UIPEthernet/utility/uipopt.h"
#if UIP_UDP
#include "Dhcp.h"
#if defined(ARDUINO)
  #include <Arduino.h>
  ...
  //#include <mbed.h>
  #include "Sources/UIPEthernet/mbed/millis.h"
  #define delay(x) vMAIN_DelayMS(x)
#endif
#include "Sources/UIPEthernet/utility/logging.h"
#include "Sources/UIPEthernet/utility/uip.h"
#include <Sources/_debug.h>
...
{
    static uint8_t set_first_state = 1;
...
uint8_t DhcpClass::parseDHCPResponse(uint32_t& transactionId)
{
    ...
    uint8_t type = 0;
    uint8_t opt_len = 0;
    //static uint8_t one_time_set = 1, sts = 1;
     
   static unsigned long startTime = millis();
//    if(one_time_set && _dhcp_state == STATE_DHCP_DISCOVER)
//    {
//        startTime = millis();
//        one_time_set = 0;
//    }
//    else if(sts && _dhcp_state == STATE_DHCP_REQUEST)
//    {
//        sts = 0;
//        startTime = 0;
//        startTime = millis();
...
//#ifdef DEBUG_ETHERNET
//        vUART_SendChr(UART_PC,',');
//        vUART_SendStr(UART_PC,"parsePacket:");
//        vUART_SendInt(UART_PC,_dhcpUdpSocket.parsePacket());
//#endif
...
//#ifdef DEBUG_ETHERNET
//        vUART_SendChr(UART_PC,',');
//  vUART_SendStr(UART_PC,"retunr_255");
//#endif
            return 255;
        }
        //delay(50);
...
//#ifdef DEBUG_ETHERNET
//        vUART_SendChr(UART_PC,',');
//  vUART_SendStr(UART_PC,"retunr_0");
//#endif
            return 0;
        }
...
//#ifdef DEBUG_ETHERNET
//        vUART_SendChr(UART_PC,',');
//  vUART_SendStr(UART_PC,"parse:");
//  vUART_SendInt(UART_PC,_dhcpUdpSocket.read());
//#endif
        while (_dhcpUdpSocket.available() > 0)
        {
        //if(_dhcpUdpSocket.available() > 0)
        //{
...
//#ifdef DEBUG_ETHERNET
//  vUART_SendChr(UART_PC,',');
//  vUART_SendStr(UART_PC,"type:");
//  vUART_SendInt(UART_PC,type);
//#endif
        //startTime = 0;
        _dhcpUdpSocket.flush();
    }
